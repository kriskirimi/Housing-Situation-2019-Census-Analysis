...
ax.pie(df1.iloc[:1,1:3], colors=['#838996', '#b2d8d8'], labels=df1.iloc[:1,1:3].columns, autopct='%1.f%%', 
       radius=1.2, startangle=25, textprops=dict(color = '#000000', fontsize=14, fontname='MingLiU_HKSCS'))
ax.set_title('Kenya\'s Rural and Urban Homeownership Rates, Census 2019', fontsize=14, fontname='MingLiU_HKSCS')
plt.tight_layout()
...
ax.set_xticklabels(df2['County/ Sub-County'].unique(), fontsize=14, fontname='MingLiU_HKSCS')
ax.set_xticks(x + barwidth)
ax.set_xlabel('County', fontsize=14, fontname='MingLiU_HKSCS')
ax.set_ylabel('% of County Population', fontsize=14, fontname='MingLiU_HKSCS')
ax.set_title('Counties (hosting major cities) Main Mode of Dwelling Aquisition, Census 2019', fontsize=14, fontname='MingLiU_HKSCS')
...
def autolabel(rects):
    for rect in rects:
        ...
        ax.text(rect.get_x(), yval + 1.8, yval, fontsize=12, fontname='MingLiU_HKSCS')
